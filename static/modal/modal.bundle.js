...
`);
  ...
  async function loadModal() {
    try {
      ...
      document.getElementById("membership-id").textContent = user["Membership ID"] || "No membership ID";
      ...
      document.querySelector(".profile").textContent = "Unable to load user details.";
    }
  }
  loadModal();
})();
